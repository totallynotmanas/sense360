...
void ESP_Wifi_Setup(void) {
    ...
    ESP_Send("AT+CWMODE=1\r\n"); 
		for(int i=0; i<500000; i++) Debug_Bridge();	// Station mode
	
    ESP_Send("AT+CWJAP=\"EdgeNode\",\"s6@23337\"\r\n"); // Connect to WiFi
    for(int i=0; i<500000; i++) Debug_Bridge();
    // Start UDP: AT+CIPSTART="UDP","LAPTOP_IP",5005
    ESP_Send("AT+CIPSTART=\"UDP\",\"192.168.56.1\",5005\r\n"); 
